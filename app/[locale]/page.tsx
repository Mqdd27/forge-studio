      ...
      <Reveal y={12} duration={0.65}>
        <section className="border-y border-border bg-alt">
          ...
          >
            ...
            <b className="font-heading font-semibold text-ink">
              {t("technology.cloudInfrastructure")}
            </b>
          </div>
        </section>
      </Reveal>
      ...
      >
        <Reveal y={20}>
          ...
          >
            ...
            <Link
              className={`${textLink} mt-5 shrink-0 sm:mt-0`}
              href="/services"
            >
              {t("services.viewAll")}
            </Link>
                ...
                >
                  <article
                    className="
                        ...
                        lg:hover:shadow-[0_8px_24px_rgba(181,80,26,0.06)]
                      "
                  >
