...
export function SiteHeader() {
  ...
  const currentLanguage =
    locale === "en" ? t("englishName") : t("indonesianName");
            ...
            ${
              scrolled
                ? `
                  ...
                  shadow-[0_14px_45px_rgba(31,31,31,0.08)]
        ...
        >
          ...
          <div
            className={`
              ...
              lg:grid-cols-[210px_minmax(0,1fr)_210px]
          ...
          >
            ...
            >
              ...
              <Link
                ...
                className={`
                  ...
                  hover:shadow-[0_8px_20px_rgba(181,80,26,0.20)]

                  xl:min-h-[42px]
                  xl:px-4
                  xl:text-[10px]

                  ${pathname === "/contact" ? "bg-accent-dark" : "bg-accent"}
                `}
              >
                <span
                  aria-hidden="true"
            ...
            >
              ...
              <button
                ...
                aria-label={
                  locale === "en" ? t("switchIndonesian") : t("switchEnglish")
                }
                className="
                  flex
                  h-9
        ...
        >
          <div
            className="
              ...
              shadow-[0_20px_60px_rgba(31,31,31,0.14)]
