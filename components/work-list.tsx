                  ...
                  <div className="flex flex-col justify-between gap-space-md lg:col-span-5">
                    ...
                    <div className="flex flex-col gap-space-sm pt-4">
                      ...
                      <div className="pt-4">
                        <Link
                          href={`/work/${item.slug}`}
                          className="inline-flex items-center gap-2 bg-white px-6 py-3 font-label-md tracking-wider text-surface uppercase transition-colors hover:bg-primary hover:text-on-primary"
                        >
